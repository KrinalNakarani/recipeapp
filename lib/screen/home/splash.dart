...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void Navigat() {
    bool check = Provider.of<RagiProvider>(context, listen: false).chckUser();
